...
public class MapManipulator {
     ...
     */
    public static HashMap<String, Integer> addMaps(HashMap<String, Integer> map1,
     ...
     */
    public static HashMap<String, Integer> gcdMaps(HashMap<String, Integer> map1,
                                                   HashMap<String, Integer> map2) {
        ...
        while (iMap.hasNext()) {
            ...
            int value = tempEntry.getValue();
            try {
                tmpNum1 = (int) (tmpNum1 * java.lang.Math.pow(Integer.parseInt(key), value));
        ...
        while (iMap.hasNext()) {
            ...
            int value = tempEntry.getValue();
            try {
                tmpNum2 = (int) (tmpNum2 * java.lang.Math.pow(Integer.parseInt(key), value));
            } catch (NumberFormatException e) {
                continue;
            }
        }
     ...
     */
    public static HashMap<String, Integer> subMaps(HashMap<String, Integer> map1,
                                                   HashMap<String, Integer> map2) {
